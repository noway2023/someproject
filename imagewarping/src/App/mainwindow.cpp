...
void MainWindow::CreateActions()
{
	...
	action_back_ = new QAction(tr("Back"), this);
	action_back_->setStatusTip(tr("Show changed image"));
	connect(action_back_, &QAction::triggered, imagewidget_, &ImageWidget::Reback);

	action_clean_ = new QAction(tr("Clear"), this);
	action_clean_->setStatusTip(tr("Clear control points"));
	connect(action_clean_, &QAction::triggered, imagewidget_, &ImageWidget::SetClean);

	action_IDW_ = new QAction(tr("IDW"), this);
	action_IDW_->setStatusTip(tr("Select IDW"));
	connect(action_IDW_, &QAction::triggered, imagewidget_, &ImageWidget::SetIDW);

	action_RBF_ = new QAction(tr("RBF"), this);
	action_RBF_->setStatusTip(tr("Select RBF"));
	connect(action_RBF_, &QAction::triggered, imagewidget_, &ImageWidget::SetRBF);
}
...
void MainWindow::CreateMenus()
{
	...
	menu_edit_->addAction(action_back_);
	menu_edit_->addAction(action_clean_);
...
void MainWindow::CreateToolBars()
{
	...
	toolbar_file_->addAction(action_back_);
	toolbar_file_->addAction(action_clean_);
